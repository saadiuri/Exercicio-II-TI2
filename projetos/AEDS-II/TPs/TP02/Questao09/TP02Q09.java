    ...
    private static void heapify(Pokemon[] findPokemon, int n, int i, int[] comp, int[] mov) {
        ...
        if (left < n) {
            ...
            if ((findPokemon[left].getHeight() > findPokemon[largest].getHeight()) ||
                    ((findPokemon[left].getHeight() == findPokemon[largest].getHeight())
                            && (findPokemon[left].getName().compareTo(findPokemon[largest].getName())) > 0)) {
        ...
        if (right < n) {
            ...
            if ((findPokemon[right].getHeight() > findPokemon[largest].getHeight()) ||
                    ((findPokemon[right].getHeight() == findPokemon[largest].getHeight())
                            && (findPokemon[right].getName().compareTo(findPokemon[largest].getName())) > 0)) {
                largest = right;
            }
